...
const Footer = () => {
  return (
    <div className="bg-footer text-gray-300">
      <div className="font-raleway max-w-[1100px] mx-auto w-full flex flex-col">
        <div className="grid grid-cols-12">
          <div className="col-span-8">
            <div className="grid grid-cols-12 gap-5">
              ...
              <div className="col-span-4 flex flex-col gap-2">
                <h1 className="heading">PRIMSTIX ASSIST</h1>
                <Link href="./">Mortgage Assist</Link>
                <Link href="./">Contact us</Link>
                <Link href="./">Properties for Sale</Link>
                <Link href="./">
                  Properties for RentDAMAC Maison Cour Jardin
                </Link>
              </div>
            </div>
          ...
          <div className="col-span-4 flex flex-col justify-center items-start  text-white ml-10 ">
            ...
            <div className='text-4xl my-4 flex gap-4'>
